...
void corr_d_eff_75() {
  const int n = 10;
  double X[n] = {0.075, 0.1, 0.1275, 0.15, 0.175, 0.2, 0.225, 0.25, 0.275, 0.3};
  double Y_sig[n] = {83.9297, 85.183, 86.2417, 86.922, 87.6339, 90.6262, 91.0609, 91.4955, 91.8546, 92.1507};
  double Y_rat[n] = {2.31379, 2.50351, 2.61876, 2.68265, 2.71258, 6.91886, 7.16063, 7.26448, 7.32518, 7.38134};
  double Y_bkg_w[n] = {99.8994, 99.9076, 99.9141, 99.9183, 99.9226, 99.9632, 99.9654, 99.9664, 99.9675, 99.9682};
  double Y_bkg_tt[n] = {99.4385, 99.5283, 99.5851, 99.617, 99.6429, 99.9111, 99.919, 99.9251, 99.9294, 99.9332};
  double Y_bkg_total[n] = {99.6507, 99.7029, 99.7366, 99.7557, 99.7717, 99.9351, 99.9403, 99.9441, 99.9469, 99.9493};
