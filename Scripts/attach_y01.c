...
void attach_y01() {
  ...
  TH1F *metbg = new TH1F("bg_met", "\\mbox{MET (background) for length cut d_1}", 100, 0, 400);
  ...
  hbg_1->Draw("HIST");
  c->SaveAs("attach_x35_d1_bg_jetht.png");
  hch_1->Draw("HIST");
  c->SaveAs("attach_x35_d1_ch_jetht.png");
  htotal_1->Draw("HIST");
  c->SaveAs("attach_x35_d1_total_jetht.png");
  hbg_2->Draw("HIST");
  c->SaveAs("attach_x35_d2_bg_jetht.png");
  hch_2->Draw("HIST");
  c->SaveAs("attach_x35_d2_ch_jetht.png");
  htotal_2->Draw("HIST");
  c->SaveAs("attach_x35_d2_total_jetht.png");
  hbg_3->Draw("HIST");
  c->SaveAs("attach_x35_d3_bg_jetht.png");
  hch_3->Draw("HIST");
  c->SaveAs("attach_x35_d3_ch_jetht.png");
  htotal_3->Draw("HIST");
  c->SaveAs("attach_x35_d3_total_jetht.png");
  hbg_4->Draw("HIST");
  c->SaveAs("attach_x35_d4_bg_jetht.png");
  hch_4->Draw("HIST");
  c->SaveAs("attach_x35_d4_ch_jetht.png");
  htotal_4->Draw("HIST");
  c->SaveAs("attach_x35_d4_total_jetht.png");
  hbg_5->Draw("HIST");
  c->SaveAs("attach_x35_d5_bg_jetht.png");
  hch_5->Draw("HIST");
  c->SaveAs("attach_x35_d5_ch_jetht.png");
  htotal_5->Draw("HIST");
  c->SaveAs("attach_x35_d5_total_jetht.png");
}
