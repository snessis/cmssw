...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        self.h_mix_chneu_deta.SetLineColor(ROOT.kRed-3)
        self.h_mix_chneu_deta.SetFillColor(ROOT.kRed-3)
        ...
        self.h_neupt.SetLineColor(ROOT.kRed-3)
        self.h_neupt.SetFillColor(ROOT.kRed-3)
        ...
        self.h_neueta.SetLineColor(ROOT.kRed-3)
        self.h_neueta.SetFillColor(ROOT.kRed-3)
