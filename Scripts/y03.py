...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        self.leg_deta.AddEntry(self.h_chdeta, "#tilde#chi_1^#pm - #tilde#chi_1^#pm", "L")
        self.leg_deta.AddEntry(self.h_mix_chmu_deta, "#tilde#chi_1^#pm - #mu", "L")
        self.leg_deta.AddEntry(self.h_mix_chnmu_deta, "#tilde#chi_1^#pm - #nu", "L")
        self.leg_deta.AddEntry(self.h_mix_chneu_deta, "#tilde#chi_1^#pm - #tilde#chi_1^0", "L")
        self.s_deta.Draw()
        self.leg_deta.Draw()
        ...
        self.leg_pt_sus.AddEntry(self.h_chpt, "#tilde#chi_1^#pm", "L" )
        self.leg_pt_sus.AddEntry(self.h_neupt, "#tilde#chi_1^0", "L")
        self.s_pt_sus.Draw()
