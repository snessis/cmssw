...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        self.leg_deta.AddEntry(self.h_chdeta, "\\tilde{\\chi}_1^\\pm-\\tilde{\\chi}_1^\\pm", "L")
        self.leg_deta.AddEntry(self.h_mix_chmu_deta, "\\tilde{\\chi}_1^\\pm-\\mu", "L")
        self.leg_deta.AddEntry(self.h_mix_chnmu_deta, "\\tilde{\\chi}_1^\\pm-\\nu", "L")
        self.leg_deta.AddEntry(self.h_mix_chneu_deta, "\\tilde{\\chi}_1^\\pm-\\tilde{\\chi}_1^0", "L")
        self.s_deta.Draw()
        self.leg_deta.Draw()
        ...
        self.leg_pt_sus = ROOT.TLegend(0.68,0.72,0.98,0.92)
        self.leg_pt_sus.AddEntry(self.h_chpt, "\\tilde{\\chi}_1^\\pm", "L" )
        self.leg_pt_sus.AddEntry(self.h_neupt, "\\tilde{\\chi}_1^0", "L")
        self.s_pt_sus.Draw()
        self.leg_pt_sus.Draw()
        self.c.SaveAs("y" + ver + "/" + "y" + ver + "_h_" + self.s_pt_sus.GetName() + ".png")
        self.c.Update()
        self.leg_pt_sm = ROOT.TLegend(0.68,0.72,0.98,0.92)
