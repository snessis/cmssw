...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        self.h_mix_chneu_deta.SetLineColor(ROOT.kRed-7)
        self.h_mix_chneu_deta.SetFillColor(ROOT.kRed-7)
        ...
        self.h_neupt.SetLineColor(ROOT.kRed-7)
        self.h_neupt.SetFillColor(ROOT.kRed-7)
        ...
        self.h_neueta.SetLineColor(ROOT.kRed-7)
        self.h_neueta.SetFillColor(ROOT.kRed-7)
        ...
        self.leg_eta_sus = ROOT.TLegend(0.8,0.80,0.90,0.90)
        ...
        self.c.Update()
        self.leg_eta_sm = ROOT.TLegend(0.8,0.80,0.90,0.90)
