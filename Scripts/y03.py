...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        leg_deta.AddEntry(self.h_chdeta, "test", "F")
        leg_deta.AddEntry(self.h_mix_chmu_deta,"test", "F")
        leg_deta.AddEntry(self.h_mix_chnmu_deta,"test", "F")
        leg_deta.AddEntry(self.h_mix_chneu_deta,"test", "F")
        leg_deta.AddEntry(self.s_deta,"test", "F")
        leg_deta.Draw()
        self.s_deta.Draw()
