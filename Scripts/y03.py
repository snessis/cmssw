...
class ExampleDisplacedAnalysis(Module):
    ...
    def endJob(self):
        ...
        self.leg_deta = ROOT.TLegend(0.80,0.80,0.95,0.95)
        self.leg_deta.AddEntry(self.h_chdeta, "#tilde{#chi}_{1}^{#pm} - #tilde{#chi}_1^#pm", "L")
        ...
        self.leg_pt_sus = ROOT.TLegend(0.80,0.85,0.95,0.95)
        ...
        self.c.Update()
        self.leg_pt_sm = ROOT.TLegend(0.80,0.85,0.95,0.95)
