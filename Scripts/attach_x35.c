...
void attach_x33() {
  ...
  TFile *f1 = new TFile("x35_1.root");
  TFile *f2 = new TFile("x35_2.root");
  TFile *f3 = new TFile("x35_3.root");
  TFile *f4 = new TFile("x35_4.root");
  TFile *f5 = new TFile("x35_5.root");
  TFile *f6 = new TFile("x35_6.root");
  TFile *f7 = new TFile("x35_7.root");
  TFile *fch = new TFile("x34.root");
