...
void sattach_y05() {
  ...
  auto leg_met_ch = new TLegend(0.65,0.7,0.9,0.95);
  ...
  metbg->SetLineColor(8);
  metbg->SetFillColor(8);
  ...
  metallbg->SetLineColor(30);
  metallbg->SetFillColor(30);
  ...
  metbg_tt->SetLineColor(3);
  metbg_tt->SetFillColor(3);
  ...
  metallbg_tt->SetLineColor(32);
  metallbg_tt->SetFillColor(32);
