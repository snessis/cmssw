...
void corr_d_eff_105() {
  ...
  double Y_sig[n] = {49.5716, 55.2665, 59.4872, 62.9772, 65.8876};
  double Y_rat[n] = {0.747159, 1.3005, 1.98684, 2.79861, 3.681};
  double Y_bkg_w[n] = {99.2684, 99.6147, 99.7424, 99.806, 99.8416,};
  double Y_bkg_tt[n] = {94.2326, 97.0895, 98.3129, 98.9386, 99.2835};
  double Y_bkg_total[n] = {96.551, 98.2521, 98.971, 99.338, 99.5404};
