...
void corr_d_eff_95() {
  const int n = 10;
  double X[n] = {0.025, 0.5, 0.075, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25};
  double Y_sig[n] = {43.0389, 45.5147, 47.9715, 50.0567, 51.808};
  double Y_rat[n] = {0.430507, 0.62169, 0.815925, 1.00466, 1.17674};
  double Y_bkg_w[n] = {97.3824, 97.3824, 98.1217, 98.2512, 98.3343,};
  double Y_bkg_tt[n] = {89.6634, 93.4895, 95.5681, 96.7966, 97.5596};
  double Y_bkg_total[n] = {93.2172, 95.5158, 96.7437, 97.4663, 97.9163};
