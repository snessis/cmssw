...
# the file to run
files = ["{}/src/DisplacedCharginos_Trees/SMS_TChiWW_Disp_200_180_10/SMS_TChiWW_Disp_200_180_10_final.root".format(os.environ['CMSSW_BASE'])]

p = PostProcessor(".", files, cut=preselection, branchsel=None, modules=[ExampleDisplacedAnalysis()], noOut=True, histFileName="histDisplacedAnalysisOut.root", histDirName="plots")
p.run()
