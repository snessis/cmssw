...
void corr_d_eff_95_pres() {
  ...
  double Y_sig[n] = {49.5716, 55.2665, 59.4872, 62.9772, 65.8876, 68.3697, 70.669, 72.5904, 74.2598, 75.9166, 77.2647, 78.5498, 79.8224, 80.9941, 82.0209, 82.9785, 84.0179, 84.9061, 85.7251, 86.5881, 87.3567, 87.9488, 88.4969, 89.1206, 89.6308, 90.1222, 90.6262, 91.0609, 91.3758, 91.7349};
  double Y_rat[n] = {0.747159, 1.3005, 1.98684, 2.79861, 3.681, 4.58607, 5.48316, 6.37937, 7.19752, 7.88509, 8.56251, 9.17425, 9.63983, 10.0484, 10.3915, 10.7372, 10.8352, 10.8951, 10.9835, 10.9204, 10.9022, 10.9489, 10.9893, 11.0466, 10.993, 11.0518, 10.9678, 11.0078, 11.1186, 11.0072};
  double Y_bkg_w[n] = {99.2684, 99.6147, 99.7424, 99.806, 99.8416, 99.8618, 99.8781, 99.8903, 99.8995, 99.9067, 99.9136, 99.9196, 99.9246, 99.9303, 99.9349, 99.9394, 99.9422, 99.9443, 99.9472, 99.949, 99.9513, 99.9534, 99.9549, 99.9579, 99.9591, 99.9612, 99.9625, 99.9645, 99.9661, 99.9667};
  double Y_bkg_tt[n] = {94.2326, 97.0895, 98.3129, 98.9386, 99.2835, 99.49, 99.6216, 99.7098, 99.7691, 99.8111, 99.8421, 99.866, 99.8839, 99.8972, 99.9077, 99.9167, 99.9238, 99.9297, 99.9347, 99.9391, 99.943, 99.9462, 99.9495, 99.9524, 99.9548, 99.9573, 99.9594, 99.9613, 99.9631, 99.9646};
  double Y_bkg_total[n] = {96.551, 98.2521, 98.971, 99.338, 99.5404, 99.6612, 99.7397, 99.7929, 99.8291, 99.8551, 99.875, 99.8907, 99.9026, 99.9124, 99.9202, 99.9271, 99.9323, 99.9364, 99.9404, 99.9437, 99.9468, 99.9495, 99.952, 99.9549, 99.9568, 99.9591, 99.9608, 99.9628, 99.9645, 99.9656};
  ...
  leg_sig->AddEntry(gr_sig,"Signal Efficiency e_{50}","p");
  leg_sig->SetTextSize(0.03);
	auto leg_rat = new TLegend(0.1,0.83,0.35,0.9);
  leg_rat->AddEntry(gr_rat,"Signal Density k_{5}","p");
  leg_rat->SetTextSize(0.035);
	auto leg_bkg = new TLegend(0.65,0.15,0.9,0.23);
  leg_bkg->AddEntry(gr_bkg_total,"Background e_{5}","p");
	leg_bkg->SetTextSize(0.035);
  c_corr->SetGridx();
  c_corr->SetGridy();
  ...
  gr_sig->Draw("AP");
  leg_sig->Draw();
  c_corr->SaveAs("corr_d_eff_sig_95_pres.png");
  gr_rat->Draw("AP");
  leg_rat->Draw();
  c_corr->SaveAs("corr_d_eff_rat_95_pres.png");
  mg_bkg->Draw("AP");
  leg_bkg->Draw();
  c_corr->SaveAs("corr_d_eff_total_95_pres.png");
}
