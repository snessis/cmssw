...
void sattach_y09() {
  ...
  TCanvas* c = new TCanvas("canv_y09", "The Canvas (post-analysis)", 1000, 700);
  ...
  metch->Draw("HIST");
  c->SaveAs("sattach_y09_ch_met.png");
  metbg->Draw("HIST");
  c->SaveAs("sattach_y09_bg_met.png");
  metbg_w->Draw("HIST");
  c->SaveAs("sattach_y09_bg_w_met.png");
  metbg_tt->Draw("HIST");
  c->SaveAs("sattach_y09_bg_tt_met.png");
  much->Draw("HIST");
  c->SaveAs("sattach_y09_ch_mupt.png");
  ...
  mubg->GetYaxis()->CenterTitle(true);
  mubg->Draw("HIST");
  c->SaveAs("sattach_y09_bg_mupt.png");
  ...
  mubg_w->GetYaxis()->CenterTitle(true);
  mubg_w->Draw("HIST");
  c->SaveAs("sattach_y09_bg_w_mupt.png");
  ...
  mubg_tt->GetYaxis()->CenterTitle(true);
  mubg_tt->Draw("HIST");
  c->SaveAs("sattach_y09_bg_tt_mupt.png");
  ...
  etach->Draw("HIST");
  c->SaveAs("sattach_y09_ch_mueta.png");
  ...
  etabg->GetYaxis()->CenterTitle(true);
  etabg->Draw("HIST");
  c->SaveAs("sattach_y09_bg_mueta.png");
  ...
  etabg_w->GetYaxis()->CenterTitle(true);
  etabg_w->Draw("HIST");
  c->SaveAs("sattach_y09_bg_w_mueta.png");
  ...
  etabg_tt->GetYaxis()->CenterTitle(true);
  etabg_tt->Draw("HIST");
  c->SaveAs("sattach_y09_bg_tt_mueta.png");
  hbg_1->Draw("HIST");
  c->SaveAs("sattach_y09_d1_bg_jetht.png");
  hch_1->Draw("HIST");
  c->SaveAs("sattach_y09_d1_ch_jetht.png");
  htotal_1->Draw("HIST");
  c->SaveAs("sattach_y09_d1_total_jetht.png");
  hbg_2->Draw("HIST");
  c->SaveAs("sattach_y09_d2_bg_jetht.png");
  hch_2->Draw("HIST");
  c->SaveAs("sattach_y09_d2_ch_jetht.png");
  htotal_2->Draw("HIST");
  c->SaveAs("sattach_y09_d2_total_jetht.png");
  hbg_3->Draw("HIST");
  c->SaveAs("sattach_y09_d3_bg_jetht.png");
  hch_3->Draw("HIST");
  c->SaveAs("sattach_y09_d3_ch_jetht.png");
  htotal_3->Draw("HIST");
  c->SaveAs("sattach_y09_d3_total_jetht.png");
  hbg_4->Draw("HIST");
  c->SaveAs("sattach_y09_d4_bg_jetht.png");
  hch_4->Draw("HIST");
  c->SaveAs("sattach_y09_d4_ch_jetht.png");
  htotal_4->Draw("HIST");
  c->SaveAs("sattach_y09_d4_total_jetht.png");
  hbg_5->Draw("HIST");
  c->SaveAs("sattach_y09_d5_bg_jetht.png");
  hch_5->Draw("HIST");
  c->SaveAs("sattach_y09_d5_ch_jetht.png");
  htotal_5->Draw("HIST");
  c->SaveAs("sattach_y09_d5_total_jetht.png");
  s_met_ch->Draw("HIST");
  leg_met_ch->Draw();
  c->SaveAs("sattach_y09_s_met_ch.png");
  s_met_w->Draw("HIST");
  leg_met_w->Draw();
  c->SaveAs("sattach_y09_s_met_bg_w.png");
  s_met_tt->Draw("HIST");
  leg_met_tt->Draw();
  c->SaveAs("sattach_y09_s_met_bg_tt.png");
  s_met->Draw("HIST");
  leg_met->Draw();
  c->SaveAs("sattach_y09_s_met_bg.png");
}
