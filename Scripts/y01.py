...
class ExampleDisplacedAnalysis(Module):
    ...
    def beginJob(self, histFile=None, histDirName=None):
        ...
        self.h_mupvdistance.GetXaxis().SetTitle("l (cm)")
                        ...
                        if mu_gmother.genPartIdxMother == nmu_gmother.genPartIdxMother: #chargino must be the same
                            for neu in neus:
                                ...
                                if mu_gmother.genPartIdxMother == neu_mother.genPartIdxMother: #end point
                                    ...
                                    g = chp4.Gamma()
                                    b = chp4.Beta()
                                    chx4_1 = ROOT.TLorentzVector(head, 0)
                                    chx4_2 = ROOT.TLorentzVector(tail, L.Mag()/b)
                                    chx4Delta = ROOT.TLorentzVector(L, L.Mag()/b)
