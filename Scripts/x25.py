#!/usr/bin/env python
ver = "25"
#x25 - ONLY muon decay channel req both Ws, solid structure of x14/19:
#assignment: same as x22, with the cuts presented in the code
import os, sys, math
...
class ExampleDisplacedAnalysis(Module):
    ...
    def beginJob(self, histFile=None, histDirName=None):
        ...
        self.h_chlenr2 = ROOT.TH1F('chlenr2', '\\mbox{Chargino Decay Length (Rest Frame, Fountas), muon channel } \gamma \tau', 80, 0, 6)
        self.h_chlenr2.GetXaxis().SetTitle("\\gamma  \\tau \\mbox{ (s)}")
        self.h_chlenr2.GetYaxis().SetTitle("Counts")
        self.addObject(self.h_chlenr2)
