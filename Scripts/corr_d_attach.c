...
void corr_d_attach() {
  const int n3 = 20;
  double X3[n3] = {0.075, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25, 0.275, 0.3, 0.325, 0.35, 0.375, 0.4, 0.425, 0.45, 0.475, 0.5, 0.525, 0.55};
  double Y3_sig[n3] = {42.6106, 47.5495, 51.8899, 55.5122, 58.9139, 61.7551, 64.3505, 66.8263, 68.8925, 70.7005, 72.477, 74.0771, 75.463, 76.7418, 78.2474, 79.4633, 80.6413, 81.7941, 82.8147, 83.6777};
  double Y3_rat[n3] = {1.91031, 2.65153, 3.41285, 4.17804, 4.89096, 5.54217, 6.09007, 6.513, 6.90085, 7.24113, 7.48959, 7.67483, 7.82832, 7.98967, 7.96348, 7.96381, 7.97872, 7.90201, 7.87612, 7.84557};
  double Y3_bkg_w[n3] = {99.5262, 99.6331, 99.6926, 99.7314, 99.7609, 99.7806, 99.7968, 99.8088, 99.8215, 99.8315, 99.8407, 99.8497, 99.8577, 99.8656, 99.8714, 99.8768, 99.8832, 99.8879, 99.8933, 99.8976};
  double Y3_bkg_tt[n3] = {97.5926, 98.4757, 98.9631, 99.2557, 99.4417, 99.5653, 99.6488, 99.7088, 99.7519, 99.7857, 99.8116, 99.8307, 99.8458, 99.8591, 99.8699, 99.8787, 99.8866, 99.8932, 99.8993, 99.9044};
  double Y3_bkg_total[n3] = {98.4828, 99.0086, 99.299, 99.4747, 99.5887, 99.6644, 99.717, 99.7548, 99.7839, 99.8068, 99.825, 99.8394, 99.8513, 99.8621, 99.8706, 99.8778, 99.885, 99.8908, 99.8965, 99.9013};
