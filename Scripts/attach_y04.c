...
void attach_y04() {
  ...
  TFile *f1 = new TFile(ver+"_1.root");
  TFile *f2 = new TFile(ver+"_2.root");
  TFile *f3 = new TFile(ver+"_3.root");
  TFile *f4 = new TFile(ver+"_4.root");
  TFile *f5 = new TFile(ver+"_5.root");
  TFile *f6 = new TFile(ver+"6.root");
  TFile *f7 = new TFile(ver+"_7.root");
  TFile *fch = new TFile(ver+".root");
  ...
  metbg->Draw("HIST");
  c->SaveAs("attach_"+ver+"_bg_met.png");
  metch->Draw("HIST");
  c->SaveAs("attach_"+ver+"_ch_met.png");
  hbg_1->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d1_bg_jetht.png");
  hch_1->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d1_ch_jetht.png");
  htotal_1->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d1_total_jetht.png");
  hbg_2->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d2_bg_jetht.png");
  hch_2->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d2_ch_jetht.png");
  htotal_2->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d2_total_jetht.png");
  hbg_3->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d3_bg_jetht.png");
  hch_3->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d3_ch_jetht.png");
  htotal_3->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d3_total_jetht.png");
  hbg_4->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d4_bg_jetht.png");
  hch_4->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d4_ch_jetht.png");
  htotal_4->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d4_total_jetht.png");
  hbg_5->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d5_bg_jetht.png");
  hch_5->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d5_ch_jetht.png");
  htotal_5->Draw("HIST");
  c->SaveAs("attach_"+ver+"_d5_total_jetht.png");
}
