...
void attach_x29() {
  ...
  l_total->Draw("HIST");
  c->SaveAs("attach_x29_lheht.png");
  h_total->Draw("HIST");
  c->SaveAs("attach_x29_jetht.png");
  hch->Draw("HIST");
  c->SaveAs("attach_x29_jetht_ch.png");
  h_ttotal->Draw("HIST");
  c->SaveAs("attach_x29_jetht_sig.png");
}
