...
void sattach_y10() {
  ...
  TH1F *metbg = new TH1F("bg_met", "\\mbox{Missing Energy Transverse MET, muonic channel (Total Background)}", 90, 0, 700);
  TH1F *metbg_w = new TH1F("bg_met_w", "\\mbox{Missing Energy Transverse MET, muonic channel (WJets Background)}", 90, 0, 700);
  TH1F *metbg_tt = new TH1F("bg_met_tt", "\\mbox{Missing Energy Transverse MET, muonic channel (TTJets Background)}", 90, 0, 700);

  TH1F *metall1 = (TH1F*)f1->Get("plots/metptall");
  TH1F *metall2 = (TH1F*)f2->Get("plots/metptall");
  TH1F *metall3 = (TH1F*)f3->Get("plots/metptall");
  TH1F *metall4 = (TH1F*)f4->Get("plots/metptall");
  TH1F *metall5 = (TH1F*)f5->Get("plots/metptall");
  TH1F *metall6 = (TH1F*)f6->Get("plots/metptall");
  TH1F *metall7 = (TH1F*)f7->Get("plots/metptall");
  TH1F *metall8 = (TH1F*)f8->Get("plots/metptall");
  TH1F *metall9 = (TH1F*)f9->Get("plots/metptall");
  TH1F *metall10 = (TH1F*)f10->Get("plots/metptall");
  TH1F *metallch = (TH1F*)fch->Get("plots/metptall");
  TH1F *metallbg = new TH1F("bg_metall", "\\mbox{Missing Energy Transverse MET (Total Background)}", 90, 0, 700);
  TH1F *metallbg_w = new TH1F("bg_metall_w", "\\mbox{Missing Energy Transverse MET (WJets Background)}", 90, 0, 700);
  TH1F *metallbg_tt = new TH1F("bg_metall_tt", "\\mbox{Missing Energy Transverse MET (TTJets Background)}", 90, 0, 700);
  ...
  metall1->Scale(1/N1*XSEC1*L*SF1*BR);
  metall2->Scale(1/N2*XSEC2*L*SF2*BR);
  metall3->Scale(1/N3*XSEC3*L*SF3*BR);
  metall4->Scale(1/N4*XSEC4*L*SF4*BR);
  metall5->Scale(1/N5*XSEC5*L*SF5*BR);
  metall6->Scale(1/N6*XSEC6*L*SF6*BR);
  metall7->Scale(1/N7*XSEC7*L*SF7*BR);
  metall8->Scale(1/N8*XSEC8*L*SF8*BR);
  metall9->Scale(1/N9*XSEC9*L*SF9*BR);
  metall10->Scale(1/N10*XSEC10*L*SF10*BR);
  metallch->Scale(1/N*XSECCH*L*SFCH*BR);
  ...
  metallbg->Add(metall1);
  metallbg->Add(metall2);
  metallbg->Add(metall3);
  metallbg->Add(metall4);
  metallbg->Add(metall5);
  metallbg->Add(metall6);
  metallbg->Add(metall7);
  metallbg->Add(metall8);
  metallbg->Add(metall9);
  metallbg->Add(metall10);
  metallbg_w->Add(metall1);
  metallbg_w->Add(metall2);
  metallbg_w->Add(metall3);
  metallbg_w->Add(metall4);
  metallbg_w->Add(metall5);
  metallbg_w->Add(metall6);
  metallbg_w->Add(metall7);
  metallbg_tt->Add(metall8);
  metallbg_tt->Add(metall9);
  metallbg_tt->Add(metall10);
  ...
  THStack *s_met_ch = new THStack();
  s_met_ch->SetTitle("\\mbox{Signal Missing Energy Transverse (MET) }; \\mbox{MET (GeV)}; \\mbox{Counts}");
  s_met_ch->Add(metch);
  s_met_ch->Add(metallch);
  auto leg_met_ch = new TLegend(0.70,0.75,0.9,0.9);
  leg_met_ch->SetMargin(0.15);
  leg_met_ch->SetTextSize(0.035);
  leg_met_ch->AddEntry(metallch,"All W^{#pm} channels","L");
  leg_met_ch->AddEntry(metch,"W^{#pm}#rightarrow #mu#nu_{#mu}","L");
  THStack *s_met_w = new THStack();
  ...
  leg_met_tt->AddEntry(metbg_tt,"W^{#pm}#rightarrow #mu#nu_{#mu}","L");
  THStack *s_met = new THStack();
  ...
  leg_met->AddEntry(metbg,"W^{#pm}#rightarrow #mu#nu_{#mu}","L");
  TCanvas* c = new TCanvas("canv_y10", "The Canvas (post-analysis)", 1000, 700);
  gStyle->SetOptStat(1110);
  gStyle->SetStatColor(18);
  metch->SetLineColor(8);
  metch->SetFillColor(8);
  ...
  metallch->SetLineColor(30);
  metallch->SetFillColor(30);
  metallch->GetXaxis()->SetTitle("\\mbox{MET (GeV)}");
  metallch->GetXaxis()->CenterTitle(true);
  metallch->GetYaxis()->SetTitle("Counts");
  metallch->GetYaxis()->CenterTitle(true);
  metbg->SetLineColor(3);
  metbg->SetFillColor(3);
  ...
  metallbg->SetLineColor(32);
  metallbg->SetFillColor(32);
  metallbg->GetXaxis()->SetTitle("\\mbox{MET (GeV)}");
  metallbg->GetXaxis()->CenterTitle(true);
  metallbg->GetYaxis()->SetTitle("Counts");
  metallbg->GetYaxis()->CenterTitle(true);
  metbg_w->SetLineColor(8);
  metbg_w->SetFillColor(8);
  ...
  metallbg_w->SetLineColor(30);
  metallbg_w->SetFillColor(30);
  metallbg_w->GetXaxis()->SetTitle("\\mbox{MET (GeV)}");
  metallbg_w->GetXaxis()->CenterTitle(true);
  metallbg_w->GetYaxis()->SetTitle("Counts");
  metallbg_w->GetYaxis()->CenterTitle(true);
  metbg_tt->SetLineColor(8);
  metbg_tt->SetFillColor(8);
  ...
  metallbg_tt->SetLineColor(30);
  metallbg_tt->SetFillColor(30);
  metallbg_tt->GetXaxis()->SetTitle("\\mbox{MET (GeV)}");
  metallbg_tt->GetXaxis()->CenterTitle(true);
  metallbg_tt->GetYaxis()->SetTitle("Counts");
  metallbg_tt->GetYaxis()->CenterTitle(true);
  mubg->SetLineColor(38);
  mubg->GetXaxis()->SetTitle("p_t \\mbox{ (GeV)}");
  mubg->GetXaxis()->CenterTitle(true);
  mubg->GetYaxis()->SetTitle("Counts");
  mubg->GetYaxis()->CenterTitle(true);
  mubg_w->SetLineColor(38);
  mubg_w->GetXaxis()->SetTitle("p_t \\mbox{ (GeV)}");
  mubg_w->GetXaxis()->CenterTitle(true);
  mubg_w->GetYaxis()->SetTitle("Counts");
  mubg_w->GetYaxis()->CenterTitle(true);
  mubg_tt->SetLineColor(38);
  mubg_tt->GetXaxis()->SetTitle("p_t \\mbox{ (GeV)}");
  ...
  metch->Draw("HIST");
  c->SaveAs("sattach_y10_ch_met.png");
  metbg->Draw("HIST");
  c->SaveAs("sattach_y10_bg_met.png");
  metbg_w->Draw("HIST");
  c->SaveAs("sattach_y10_bg_w_met.png");
  metbg_tt->Draw("HIST");
  c->SaveAs("sattach_y10_bg_tt_met.png");
  much->Draw("HIST");
  c->SaveAs("sattach_y10_ch_mupt.png");
  ...
  mubg->GetYaxis()->CenterTitle(true);
  mubg->Draw("HIST");
  c->SaveAs("sattach_y10_bg_mupt.png");
  ...
  mubg_w->GetYaxis()->CenterTitle(true);
  mubg_w->Draw("HIST");
  c->SaveAs("sattach_y10_bg_w_mupt.png");
  ...
  mubg_tt->GetYaxis()->CenterTitle(true);
  mubg_tt->Draw("HIST");
  c->SaveAs("sattach_y10_bg_tt_mupt.png");
  etach->SetLineColor(kCyan+2);
  etach->SetFillColor(kCyan+2);
  etach->SetLineWidth(2);
  etach->GetXaxis()->CenterTitle(true);
  etach->GetYaxis()->CenterTitle(true);
  etach->Draw("HIST");
  c->SaveAs("sattach_y10_ch_mueta.png");
  ...
  etabg->GetYaxis()->CenterTitle(true);
  etabg->Draw("HIST");
  c->SaveAs("sattach_y10_bg_mueta.png");
  ...
  etabg_w->GetYaxis()->CenterTitle(true);
  etabg_w->Draw("HIST");
  c->SaveAs("sattach_y10_bg_w_mueta.png");
  ...
  etabg_tt->GetYaxis()->CenterTitle(true);
  etabg_tt->Draw("HIST");
  c->SaveAs("sattach_y10_bg_tt_mueta.png");
  hbg_1->Draw("HIST");
  c->SaveAs("sattach_y10_d1_bg_jetht.png");
  hch_1->Draw("HIST");
  c->SaveAs("sattach_y10_d1_ch_jetht.png");
  htotal_1->Draw("HIST");
  c->SaveAs("sattach_y10_d1_total_jetht.png");
  hbg_2->Draw("HIST");
  c->SaveAs("sattach_y10_d2_bg_jetht.png");
  hch_2->Draw("HIST");
  c->SaveAs("sattach_y10_d2_ch_jetht.png");
  htotal_2->Draw("HIST");
  c->SaveAs("sattach_y10_d2_total_jetht.png");
  hbg_3->Draw("HIST");
  c->SaveAs("sattach_y10_d3_bg_jetht.png");
  hch_3->Draw("HIST");
  c->SaveAs("sattach_y10_d3_ch_jetht.png");
  htotal_3->Draw("HIST");
  c->SaveAs("sattach_y10_d3_total_jetht.png");
  hbg_4->Draw("HIST");
  c->SaveAs("sattach_y10_d4_bg_jetht.png");
  hch_4->Draw("HIST");
  c->SaveAs("sattach_y10_d4_ch_jetht.png");
  htotal_4->Draw("HIST");
  c->SaveAs("sattach_y10_d4_total_jetht.png");
  hbg_5->Draw("HIST");
  c->SaveAs("sattach_y10_d5_bg_jetht.png");
  hch_5->Draw("HIST");
  c->SaveAs("sattach_y10_d5_ch_jetht.png");
  htotal_5->Draw("HIST");
  c->SaveAs("sattach_y10_d5_total_jetht.png");
  s_met_ch->Draw("HIST");
  leg_met_ch->Draw();
  c->SaveAs("sattach_y10_s_met_ch.png");
  s_met_w->Draw("HIST");
  leg_met_w->Draw();
  c->SaveAs("sattach_y10_s_met_bg_w.png");
  s_met_tt->Draw("HIST");
  leg_met_tt->Draw();
  c->SaveAs("sattach_y10_s_met_bg_tt.png");
  s_met->Draw("HIST");
  leg_met->Draw();
  c->SaveAs("sattach_y10_s_met_bg.png");
}
