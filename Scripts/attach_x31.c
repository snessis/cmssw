...
void attach_x31() {
  ...
  TFile *f1 = new TFile("x31_1.root");
  TFile *f2 = new TFile("x31_2.root");
  TFile *f3 = new TFile("x31_3.root");
  TFile *f4 = new TFile("x31_4.root");
  TFile *f5 = new TFile("x31_5.root");
  TFile *f6 = new TFile("x31_6.root");
  TFile *f7 = new TFile("x31_7.root");
